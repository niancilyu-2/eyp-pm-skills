...
Apply `.agents/skills/pm-prototype/references/rigor-checklist.md` (if unreadable, tell the user before
...
`.agents/skills/pm-prototype/references/zero-build-build.md`. Escalate to React only for genuinely heavy
state/routing, choosing one of two bundled paths (see
`.agents/skills/pm-prototype/references/react-escalation.md`):
...
### Anti-"AI slop" design
Follow `.agents/skills/pm-prototype/references/anti-slop.md`: no purple gradients, no everything-centered
...
Start from `.agents/skills/pm-prototype/templates/prototype-template.html` and customize for the feature.
...
`.agents/skills/pm-prototype/references/zero-build-build.md`. Put the product name in the top bar.
...
`.agents/skills/pm-prototype/references/react-escalation.md`):
- **Lite:** `bash .agents/skills/pm-prototype/scripts/lite/init-artifact.sh <name>` →
  `bash .agents/skills/pm-prototype/scripts/lite/bundle-artifact.sh <name>` (→ `dist/index.html`).
- **Full (shadcn/ui):** `bash .agents/skills/pm-prototype/scripts/web-artifacts-builder/init-artifact.sh
  <name>` → `bash .agents/skills/pm-prototype/scripts/web-artifacts-builder/bundle-artifact.sh` (→
  `bundle.html`).
...
2. `workshop/outputs/<feature>-prototype-notes.md` — scaffold it from
   `.agents/skills/pm-prototype/templates/prototype-notes-template.md` (hypothesis, chosen + rejected
...
### Bundled references
- `.agents/skills/pm-prototype/references/rigor-checklist.md` — the shared accuracy layer.
- `.agents/skills/pm-prototype/templates/prototype-template.html` — the zero-build scaffold.
- `.agents/skills/pm-prototype/references/zero-build-build.md`, `references/anti-slop.md`,
  `references/react-escalation.md`.
- `.agents/skills/pm-prototype/scripts/lite/` — lite Vite single-file React path.
- `.agents/skills/pm-prototype/scripts/web-artifacts-builder/` — Anthropic's web-artifacts-builder, vendored
