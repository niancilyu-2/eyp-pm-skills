...
```bash
bash .agents/skills/pm-prototype/scripts/lite/init-artifact.sh my-proto   # Vite + React + TS + Tailwind
...
bash .agents/skills/pm-prototype/scripts/lite/bundle-artifact.sh my-proto # -> my-proto/dist/index.html
```
...
```bash
bash .agents/skills/pm-prototype/scripts/web-artifacts-builder/init-artifact.sh my-proto   # + 40 shadcn components
cd my-proto && npm run dev
# build the artifact by editing the generated code (shadcn components live in src/)
bash .agents/skills/pm-prototype/scripts/web-artifacts-builder/bundle-artifact.sh          # -> bundle.html (single file)
```
...
Follow `.agents/skills/pm-prototype/references/anti-slop.md` — web-artifacts-builder's own guidance says the
