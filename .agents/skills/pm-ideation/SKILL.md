...
`.agents/skills/pm-ideation/examples/output-format.md` (what a finished deliverable contains). **Examples are structural only — derive names, paths, and numbers from the actual inputs of this run; never copy citations or figures from examples.**
