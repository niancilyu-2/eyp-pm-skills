...
Read and apply `.agents/skills/pm-ideation/references/rigor-checklist.md`. Every rule there is in force:
...
commands per type live in `.agents/skills/pm-ideation/references/ingest.md`.
...
Parse each input using `.agents/skills/pm-ideation/references/ingest.md`. For tabular data (churn), extract
...
`.agents/skills/pm-ideation/references/problem-statement-template.md`: the empathy framing (I am / trying
...
Use `.agents/skills/pm-ideation/references/roadmap-rec-template.md`: transparent RICE (sourced inputs +
...
**More examples:** `.agents/skills/pm-ideation/examples/walkthrough.md` (one example per step, 0–5) and
`.agents/skills/pm-ideation/examples/sample-output.md` (a full finished deliverable). **These examples are illustrative of one scenario — derive names, paths, and numbers only from the actual inputs of this run; never copy citations or figures from examples.**
...
### Bundled references
- `.agents/skills/pm-ideation/references/rigor-checklist.md` — the shared accuracy layer.
- `.agents/skills/pm-ideation/references/ingest.md` — multi-format ingestion commands.
- `.agents/skills/pm-ideation/references/problem-statement-template.md`
- `.agents/skills/pm-ideation/references/roadmap-rec-template.md`
