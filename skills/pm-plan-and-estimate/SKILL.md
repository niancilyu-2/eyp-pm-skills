...
fallbacks for when `cloc`/`scc` are absent) are in `${CLAUDE_SKILL_DIR}/references/cost-models.md`.
...
rules are in `${CLAUDE_SKILL_DIR}/references/pert.md`.
...
their size using `${CLAUDE_SKILL_DIR}/references/cost-models.md`. Exclude generated/vendored code.
...
Use `${CLAUDE_SKILL_DIR}/references/planning-doc-template.md`. Decompose into milestones, each in one
...
Use `${CLAUDE_SKILL_DIR}/references/estimate-template.md` + `pert.md` + `cost-models.md`. Effort by
...
Generate a design spec with `${CLAUDE_SKILL_DIR}/references/spec-template.md`. This is the bridge to
...
- `${CLAUDE_SKILL_DIR}/references/cost-models.md` — measurement + dollar cross-check methods.
- `${CLAUDE_SKILL_DIR}/references/pert.md` — PERT math and roll-up.
- `${CLAUDE_SKILL_DIR}/references/planning-doc-template.md`, `estimate-template.md`, `spec-template.md`.
